...
export interface ApiAboutAbout extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    contactButton: Schema.Attribute.Component<'shared.button', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    media: Schema.Attribute.Component<'about.media', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    publishedAt: Schema.Attribute.DateTime;
    team: Schema.Attribute.Component<'about.team', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiExperienceExperience extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    alternativeTitle: Schema.Attribute.String;
    banner: Schema.Attribute.Component<'stories.banner', false>;
    button: Schema.Attribute.Component<'shared.button', false>;
    categories: Schema.Attribute.Component<'stories.category', true>;
...
export interface ApiGeneralGeneral extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    navbar: Schema.Attribute.Component<'shared.link', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiImpressumImpressum extends Struct.SingleTypeSchema {
  ...
  attributes: {
    contact: Schema.Attribute.Component<'legal.contact', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    dataPrivacy: Schema.Attribute.Component<'legal.data-privacy', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    >;
    photos: Schema.Attribute.Component<'legal.photos', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    webdesign: Schema.Attribute.Component<'legal.webdesign', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiSupportSupport extends Struct.SingleTypeSchema {
  ...
  attributes: {
    accordion: Schema.Attribute.Component<'support.accordion-item', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    inbetweenParagraph: Schema.Attribute.Blocks &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    inbetweenTitle: Schema.Attribute.Text &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    links: Schema.Attribute.Component<'support.links-group', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    tipsExperts: Schema.Attribute.Component<'support.tips-experts', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
